...
const titlesArrozSecano = [
  ...
  'Posemergencia temprana (12 a 15 después de la siembra)',
  'Fertilizancion de siembra # 1 (13 a 16 después de la siembra)',
  'Posemergencia tardía (20 a 25 después de la siembra)',
  'Fertilizancion # 2 (22 a 25 después de la siembra)',
  'Control de enfermedades (Intermedia 25 a 28 después de la siembra)',
  'Fertilizancion # 3 (33 a 38 después de la siembra)',
  'Control de enfermedades (Preventiva 40 a 45 después de la siembra)',
  'Fertilizancion # 4 (48 a 50 después de la siembra)',
  'Control de enfermedades (Embuchamieto 65 a 70 después de la siembra)',
  'Proteccion de espiga (85 a 90 después de la siembra)',
  'Fecha de cosecha (110 a 120 después de la siembra)',
];
...
const titleArrozRiego = [
  ...
  'Premergencia total (0 a 3 después de la siembra)',
  'Posemergencia temprana (10 a 12 después de la siembra)',
  'Fertilizancion de siembra # 1 (12 a 18 después de la siembra)',
  'Posemergencia tardía (20 a 22 después de la siembra)',
  'Fertilizancion # 2 (25 después de la siembra)',
  'Control de hongos (Prepreventiva 25 - 30 después de la siembra)',
  'Fertilización #3 (30 a 38 después de la siembra)',
  'Control de Hongos - Preventiva (45 a 48 después de la siembra)',
  'Fertilizanción #4 (45 a 50 después de la siembra)',
  'Aplicacion de Embuchamiento (65 a 70 después de la siembra)',
  'Proteccion de espiga o de grano (85 - 90 después de la siembra)',
  'Fecha de Cosecha (110 a 120 después de la siembra)',
];
